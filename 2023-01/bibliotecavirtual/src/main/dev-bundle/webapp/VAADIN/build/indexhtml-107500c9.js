...
\f\r]`,un=`[^ 	
\f\r"'\`<>=]`,mn=`[^\\s"'>=/]`,ge=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,go=1,gt=2,hn=3,vo=/-->/g,bo=/>/g,X=new RegExp(`>|${ft}(?:(${mn}+)(${ft}*=${ft}*(?:${un}|("|')|))|$)`,"g"),pn=0,yo=1,fn=2,xo=3,vt=/'/g,bt=/"/g,Wo=/^(?:script|style|textarea|title)$/i,gn=1,Ke=2,Mt=1,Ye=2,vn=3,bn=4,yn=5,Dt=6,xn=7,Go=o=>(e,...t)=>(e.some(i=>i===void 0)&&console.warn(`Some template strings are undefined.
This is probably caused by illegal octal escape sequences.`),{_$litType$:o,strings:e,values:t}),R=Go(gn),xr=Go(Ke),Z=Symbol.for("lit-noChange"),S=Symbol.for("lit-nothing"),wo=new WeakMap,ce=ue.createTreeWalker(ue,129,null,!1);let ee=Je;const wn=(o,e)=>{const t=o.length-1,i=[];let n=e===Ke?"<svg>":"",r,s=ge;for(let a=0;a<t;a++){const c=o[a];let u=-1,p,h=0,f;for(;h<c.length&&(s.lastIndex=h,f=s.exec(c),f!==null);)if(h=s.lastIndex,s===ge){if(f[go]==="!--")s=vo;else if(f[go]!==void 0)s=bo;else if(f[gt]!==void 0)Wo.test(f[gt])&&(r=new RegExp(`</${f[gt]}`,"g")),s=X;else if(f[hn]!==void 0)throw new Error("Bindings in tag names are not supported. Please use static templates instead. See https://lit.dev/docs/templates/expressions/#static-expressions")}else s===X?f[pn]===">"?(s=r??ge,u=-1):f[yo]===void 0?u=-2:(u=s.lastIndex-f[fn].length,p=f[yo],s=f[xo]===void 0?X:f[xo]==='"'?bt:vt):s===bt||s===vt?s=X:s===vo||s===bo?s=ge:(s=X,r=void 0);console.assert(u===-1||s===X||s===vt||s===bt,"unexpected parse state B");const G=s===X&&o[a+1].startsWith("/>")?" ":"";n+=s===ge?c+cn:u>=0?(i.push(p),c.slice(0,u)+It+c.slice(u)+W+G):c+W+(u===-2?(i.push(void 0),a):G)}const l=n+(o[t]||"<?>")+(e===Ke?"</svg>":"");if(!Array.isArray(o)||!o.hasOwnProperty("raw")){let a="invalid template strings array";throw a=`
...
`,x=class extends te{constructor(){super(),this.expanded=!1,this.messages=[],this.notifications=[],this.frontendStatus="unavailable",this.javaStatus="unavailable",this.tabs=[{id:"log",title:"Log",render:this.renderLog,activate:this.activateLog},{id:"info",title:"Info",render:this.renderInfo},{id:"features",title:"Feature Flags",render:this.renderFeatures}],this.activeTab="log",this.serverInfo={flowVersion:"",vaadinVersion:"",javaVersion:"",osVersion:"",productName:""},this.features=[],this.unreadErrors=!1,this.componentPickActive=!1,this.nextMessageId=1,this.transitionDuration=0,window.Vaadin.Flow&&this.tabs.push({id:"code",title:"Code",render:this.renderCode})}static get styles(){return[y`
    ...
    `}render(){return R` <div
      ...
      <div>
        ...
        <button
          class="button pick"
          @click=${()=>{this.componentPickActive=!0,Be(()=>import("./component-picker-7deeb3da.js"),["./component-picker-7deeb3da.js","./custom-element-1c6555a1.js"],import.meta.url)}}
        >
...
`,oi=document.createElement("template");oi.innerHTML=`<style>${sr.toString().replace(":host","html")}</style>`;document.head.appendChild(oi.content);const ii=y`
  [theme~='dark'] {
    /* Base (background) */
...
${fr}
${gr}
`;Qe("",li,{moduleId:"lumo-utility"});const be=(o,e)=>{const t=document.createElement("style");t.type="text/css",t.appendChild(document.createTextNode(o)),e===document?document.head.appendChild(t):e.appendChild(t)};window.Vaadin=window.Vaadin||{};window.Vaadin.theme=window.Vaadin.theme||{};window.Vaadin.theme.injectedGlobalCss=[];const vr=o=>{document._vaadintheme_bibliotecavirtual_componentCss||(document._vaadintheme_bibliotecavirtual_componentCss=!0),be(ei.cssText,o),be(ii.cssText,o),be(ni.cssText,o),be(ai.cssText,o),be(li.cssText,o)},br=vr;br(document);export{On as D,te as L,An as P,_r as T,Qn as a,Ue as b,y as c,Z as d,Pn as e,ii as f,Xo as g,R as h,Jn as i,fe as j,S as n,_ as p,In as q,Qe as r,xr as s,ei as t,en as u};
